...
- **Evaluation**: Semantic Retrieval Test, Judge Calibration Set(v1 17개 / v2 44개), RAGAS Faithfulness(Calibration Set 기준 평균 0.4412), Retrieval 전용 평가셋(65문항 5유형 — 검색 평가는 in-scope 38문항 기준 Top-1 100%·Faithfulness 0.9702·Context Precision 1.0000, 범위 밖 27문항은 근거 없음 판정용), Embedding 비교(KB 29개·30문항 기준: Gemini 100%/0.9702 > ko-sroberta 86.7%/0.8931. KB 18개·20문항 시점에는 결론이 반대였음)
